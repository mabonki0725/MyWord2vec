...
const int vocab_hash_size = 50000;//500000000; //nakai // Maximum 500M entries in the vocabulary
...
long vocab_max_size = 10000, vocab_size = 0;
long train_words = 0;
real threshold = 100;
...
int main(int argc, char **argv) {
  ...
  if ((i = ArgPos((char *)"-threshold", argc, argv)) > 0) threshold = (float)atof(argv[i + 1]); //nakai
